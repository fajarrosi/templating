...
@section('title')
<h1 class="m-0 text-dark">Pertanyaan</h1> <br>
<h1><button name="btn_add" id="btn_add" class="btn btn-primary btn-sm">tambah pertanyaan</button></h1>
@endsection
@section('breadcrumb')
      ...
      <div class="modal-body">
        ...
        <form method="post" id="add" class="form-horizontal" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label class="control-label col-md-4" >Judul pertanyaan : </label>
						<div class="col-md-8">
...
<script>
  $(function () {
    ...
    $('#btn_add').click(function(){
			...
			$('#name').val("");
			$('#form_result').hide();
			$('#createModal .modal-title').text("Tambah pertanyaan");
			$('#action').val("tambah");
	});
					...
					success:function(data)
					{
						$('#form_result').show();
							...
							if(data.success)
							{
								...
								toastr.success('Pertanyaan telah berhasil ditambahkan!', 'Success', {timeOut: 5000});
							}
					...
					success:function(data)
					{
						...
						var html = '';
							...
							if(data.success)
							{
								...
								$('#tab_data').DataTable().ajax.reload();
								toastr.success('pertanyaan telah berhasil diupdate!', 'Success', {timeOut: 5000});
							}
	...
	$(document).on('click','.edit',function(){
		id_table = $(this).attr('id');
			...
			$('#action').val("edit");
			$('.disp').hide();
			$('#createModal .modal-title').text("Edit Pertanyaan");
			$.ajax({
				url:"/pertanyaan/"+id_table+"/edit",
				dataType:"json",
	...
	$(document).on('click','.delete',function(){
		...
		$('#ok_button').click(function(){
			$.ajax({
				url:"pertanyaan/destroy/"+id_table,
				beforeSend:function(){
				...
				success:function(data)
				{
					setTimeout(function(){
						...
						toastr.success('Pertanyaan telah berhasil dihapus!', 'Success', {timeOut: 5000});
				}
			})
		});
  });
